...
table2latex(SSA_Quantity.Stats, 'Output/Tables/SSA_Quantity.tex')
table2latex(SSA_Quantity.FACTOR, 'Output/Tables/SSA_Quantity_FACTOR.tex');
table2latex(SSA_Quantity.AFACTOR, 'Output/Tables/SSA_Quantity_AFACTOR.tex');


% *************************** SSA - Vol with individual quantity trend  *************************** 
table2latex(SSA_IndQuantity.Stats, 'Output/Tables/SSA_IndQuantity.tex')
table2latex(SSA_IndQuantity.FACTOR, 'Output/Tables/SSA_IndQuantity_FACTOR.tex');
table2latex(SSA_IndQuantity.AFACTOR, 'Output/Tables/SSA_IndQuantity_AFACTOR.tex');
